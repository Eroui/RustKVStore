...
| **Foundations 2** | **Chapter 4: Ownership & Borrowing** | Move semantics, Borrowing (`&` vs `&mut`), References, Slices | ✅ *Completed* |
| **Foundations 3** | **Chapter 5: Structs & Methods** | `struct`, `impl`, `self`, `&self`, `&mut self`, Associated functions | 🔄 *In Progress* |
